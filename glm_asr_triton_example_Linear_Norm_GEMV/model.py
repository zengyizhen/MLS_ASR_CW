...
class AudioEncoderLayer:
    ...
    def __init__(
        ...
        self.q_proj = Linear(hidden_size, hidden_size, bias=True, backend="triton")
        self.k_proj = Linear(hidden_size, hidden_size, bias=True, backend="triton")
        self.v_proj = Linear(hidden_size, hidden_size, bias=True, backend="triton")
        self.out_proj = Linear(hidden_size, hidden_size, bias=True, backend="triton")

        # MLP
        self.fc1 = Linear(hidden_size, intermediate_size, bias=True, backend="triton")
        self.fc2 = Linear(intermediate_size, hidden_size, bias=True, backend="triton")
...
class MultiModalProjector:
    ...
    def __init__(self, config: GlmAsrConfig):
        ...
        self.linear_1 = Linear(pooled_dim, config.projector_hidden_size, bias=True, backend="triton")
        self.act = gelu
        self.linear_2 = Linear(
            config.projector_hidden_size, config.text_hidden_size, bias=True, backend="triton"
        )
